  ...
  return (
    <div className="auth-page">
      <div className="auth-card" style={{ textAlign: 'center' }}>
        <div className="auth-logo" style={{ background: 'rgba(239, 68, 68, 0.1)', color: 'var(--color-error)', margin: '0 auto 1.5rem auto' }}>
          <ShieldOff size={32} />
        </div>
        ...
        <p style={{ color: 'var(--color-text-secondary)', marginBottom: '2rem', lineHeight: '1.6' }}>
          Olá, <strong>{profile?.full_name || 'usuário'}</strong>!<br/>
          Sua conta foi bloqueada no sistema. Se isso foi um engano, entre em contato com o suporte.
        </p>
